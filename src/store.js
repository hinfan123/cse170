		...
		recipeList: [
			{
				...
				steps: [
					...
					{ // step 5
						n: 5,
						title: 'Cut Peppers',
						gifURL: 'https://gph.is/2Ph2psO',
						details: 'Thinly cut garlic.',
						timer: false,
						duration: 0
					},
					{ // step 6
